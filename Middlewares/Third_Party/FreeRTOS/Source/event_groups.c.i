# 1 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/event_groups.c"
...
# 1 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/event_groups.c"
# 29 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/event_groups.c"
...
# 30 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/event_groups.c" 2
...
# 38 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/event_groups.c" 2
...
# 39 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/event_groups.c" 2
...
# 40 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/event_groups.c" 2
...
# 41 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/event_groups.c" 2
...
# 57 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/event_groups.c"
...
# 88 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/event_groups.c"
static BaseType_t prvTestWaitCondition (const EventBits_t uxCurrentEventBits, const EventBits_t uxBitsToWaitFor,
          const BaseType_t xWaitForAllBits) ;
# 146 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/event_groups.c"
EventGroupHandle_t xEventGroupCreate (void)
{
 ...
 if (pxEventBits != 
# 153 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/event_groups.c" 3 4
                   ((void *)0)
# 153 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/event_groups.c"
                       )
 {
  pxEventBits->uxEventBits = 0;
  vListInitialise (&(pxEventBits->xTasksWaitingForBits));
# 167 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/event_groups.c"
  ;
 }
 else
 {
        ...
        const EventBits_t uxBitsToWaitFor, TickType_t xTicksToWait)
{
 ...
 if (((uxBitsToWaitFor & 0xff000000UL) == 0) == 0) {__asm volatile ( " cpsid i " ::: "memory" ); Error_Handler (); for( ;; );};
 if ((uxBitsToWaitFor != 0) == 0) {__asm volatile ( " cpsid i " ::: "memory" ); Error_Handler (); for( ;; );};
  ...
  else
  {
   if (xTicksToWait != (TickType_t)0)
   {
    ...
    vTaskPlaceOnUnorderedEventList (
     ...
     (uxBitsToWaitFor | 0x01000000UL | 0x04000000UL), xTicksToWait);
         ...
         TickType_t xTicksToWait)
{
 ...
 if ((xEventGroup) == 0) {__asm volatile ( " cpsid i " ::: "memory" ); Error_Handler (); for( ;; );};
 if (((uxBitsToWaitFor & 0xff000000UL) == 0) == 0) {__asm volatile ( " cpsid i " ::: "memory" ); Error_Handler (); for( ;; );};
 if ((uxBitsToWaitFor != 0) == 0) {__asm volatile ( " cpsid i " ::: "memory" ); Error_Handler (); for( ;; );};
...
EventBits_t xEventGroupClearBits (EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToClear)
{
 ...
 if ((xEventGroup) == 0) {__asm volatile ( " cpsid i " ::: "memory" ); Error_Handler (); for( ;; );};
 if (((uxBitsToClear & 0xff000000UL) == 0) == 0) {__asm volatile ( " cpsid i " ::: "memory" ); Error_Handler (); for( ;; );};
...
# 499 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/event_groups.c"
EventBits_t xEventGroupGetBitsFromISR (EventGroupHandle_t xEventGroup)
{
...
EventBits_t xEventGroupSetBits (EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet)
{
 ...
 if ((xEventGroup) == 0) {__asm volatile ( " cpsid i " ::: "memory" ); Error_Handler (); for( ;; );};
 if (((uxBitsToSet & 0xff000000UL) == 0) == 0) {__asm volatile ( " cpsid i " ::: "memory" ); Error_Handler (); for( ;; );};
  ...
  while (pxListItem != pxListEnd)
  {
   ...
   if (xMatchFound != ( ( BaseType_t ) 0 ))
   {
    ...
    vTaskRemoveFromUnorderedEventList (pxListItem,
               pxEventBits->uxEventBits | 0x02000000UL);
   }
...
void vEventGroupDelete (EventGroupHandle_t xEventGroup)
{
 ...
 vTaskSuspendAll ();
 {
  ...
  while (( ( pxTasksWaitingForBits )->uxNumberOfItems ) > (UBaseType_t)0)
  {
   ...
   if ((pxTasksWaitingForBits->xListEnd.pxNext != (const ListItem_t *)&(pxTasksWaitingForBits->xListEnd)) == 0) {__asm volatile ( " cpsid i " ::: "memory" ); Error_Handler (); for( ;; );}
                                                                  ;
...
# 649 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/event_groups.c"
 }
 (void)xTaskResumeAll ();
}
...
# 725 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/event_groups.c"
UBaseType_t uxEventGroupGetNumber (void *xEventGroup)
{
 UBaseType_t xReturn;
 EventGroup_t *pxEventBits = (EventGroup_t *)xEventGroup;
 ...
 if (xEventGroup == 
# 730 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/event_groups.c" 3 4
                   ((void *)0)
# 730 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/event_groups.c"
                       )
 {
  xReturn = 0;
 }
