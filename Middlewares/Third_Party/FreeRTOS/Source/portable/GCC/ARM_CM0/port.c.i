# 1 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/GCC/ARM_CM0/port.c"
...
# 1 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/GCC/ARM_CM0/port.c"
# 33 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/GCC/ARM_CM0/port.c"
...
# 34 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/GCC/ARM_CM0/port.c" 2
...
# 35 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/GCC/ARM_CM0/port.c" 2
...
# 133 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/GCC/ARM_CM0/port.c"
StackType_t *pxPortInitialiseStack (StackType_t *pxTopOfStack, TaskFunction_t pxCode, void *pvParameters)
{
...
static void prvTaskExitError (void)
{
 ...
 if ((uxCriticalNesting == ~0UL) == 0) {__asm volatile ( " cpsid i " ::: "memory" ); Error_Handler (); for( ;; );};
...
void vPortEndScheduler (void)
{
 ...
 if ((uxCriticalNesting == 1000UL) == 0) {__asm volatile ( " cpsid i " ::: "memory" ); Error_Handler (); for( ;; );};
}
...
{
 if ((uxCriticalNesting) == 0) {__asm volatile ( " cpsid i " ::: "memory" ); Error_Handler (); for( ;; );};
 uxCriticalNesting--;
...
# 544 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/GCC/ARM_CM0/port.c"
void prvSetupTimerInterrupt (void)
{
# 556 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/GCC/ARM_CM0/port.c"
