# 1 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c"
...
# 1 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c"
# 36 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c"
...
# 37 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c" 2
...
# 44 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c" 2
...
# 45 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c" 2
...
static uint8_t ucHeap[((size_t)6000)];
...
# 83 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c"
...
static const size_t xHeapStructSize
 = (sizeof (BlockLink_t) + ((size_t) (8 - 1))) & ~((size_t)( 0x0007 ));


static BlockLink_t xStart, *pxEnd = 
# 99 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c" 3 4
                                   ((void *)0)
# 99 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c"
                                       ;
...
void *pvPortMalloc (size_t xWantedSize)
{
 ...
 void * pvReturn = 
# 117 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c" 3 4
                    ((void *)0)
# 117 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c"
                        ;
 ...
 vTaskSuspendAll ();
 {
  ...
  if (pxEnd == 
# 123 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c" 3 4
              ((void *)0)
# 123 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c"
                  )
  {
   prvHeapInit ();
  }
  ...
  if ((xWantedSize & xBlockAllocatedBit) == 0)
  {
   ...
   if (xWantedSize > 0)
   {
    ...
    if ((xWantedSize & ( 0x0007 )) != 0x00)
    {
     ...
     if (((xWantedSize & ( 0x0007 )) == 0) == 0) {__asm volatile ( " cpsid i " ::: "memory" ); Error_Handler (); for( ;; );};
    }
    else
    {
     ;
...
# 168 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c" 3 4
                                                                              ((void *)0)
# 168 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c"
                                                                                  ))
    {
    ...
    if (pxBlock != pxEnd)
    {
     ...
     if ((pxBlock->xBlockSize - xWantedSize) > ((size_t) (xHeapStructSize << 1)))
     {
      ...
      if (((((size_t)pxNewBlockLink) & ( 0x0007 )) == 0) == 0) {__asm volatile ( " cpsid i " ::: "memory" ); Error_Handler (); for( ;; );};
...
# 224 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c" 3 4
                               ((void *)0)
# 224 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c"
                                   ;
    }
    else
    {
 ...
 (void)xTaskResumeAll ();
# 259 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c"
 if (((((size_t)pvReturn) & (size_t)( 0x0007 )) == 0) == 0) {__asm volatile ( " cpsid i " ::: "memory" ); Error_Handler (); for( ;; );};
 return pvReturn;
}
...
void vPortFree (void *pv)
{
 ...
 if (pv != 
# 269 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c" 3 4
          ((void *)0)
# 269 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c"
              )
 {
  ...
  if (((pxLink->xBlockSize & xBlockAllocatedBit) != 0) == 0) {__asm volatile ( " cpsid i " ::: "memory" ); Error_Handler (); for( ;; );};
  if ((pxLink->pxNextFreeBlock == 
# 280 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c" 3 4
 ((void *)0)
# 280 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c"
 ) == 0) {__asm volatile ( " cpsid i " ::: "memory" ); Error_Handler (); for( ;; );};

  if ((pxLink->xBlockSize & xBlockAllocatedBit) != 0)
  {
   if (pxLink->pxNextFreeBlock == 
# 284 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c" 3 4
                                 ((void *)0)
# 284 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c"
                                     )
   {
...
static void prvHeapInit (void)
{
 ...
 size_t uxAddress;
 size_t xTotalHeapSize = ((size_t)6000);
...
# 361 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c" 3 4
                         ((void *)0)
# 361 "1734-stm32f072/Middlewares/Third_Party/FreeRTOS/Source/portable/MemMang/heap_4.c"
                             ;
