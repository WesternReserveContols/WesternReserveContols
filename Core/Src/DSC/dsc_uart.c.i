# 1 "1734-stm32f072/Src/DSC/dsc_uart.c"
...
# 12 "1734-stm32f072/Src/DSC/dsc_uart.h" 2


# 13 "1734-stm32f072/Src/DSC/dsc_uart.h"
void MX_DSC_UART_Init (void);
void UART5_Start_DMA_TX (uint8_t *buffer, uint8_t length);
# 8 "1734-stm32f072/Src/DSC/dsc_uart.c" 2
...
# 41 "./1734-stm32f072/Drivers/STM32F0xx_HAL_Driver/Inc/stm32f0xx_hal_def.h"
typedef enum
{
  HAL_OK = 0x00U,
  HAL_ERROR = 0x01U,
...
# 9 "1734-stm32f072/Src/DSC/dsc_uart.c" 2
# 1 "./1734-stm32f072/Src/1734_debug.h" 1
# 9 "./1734-stm32f072/Src/1734_debug.h"
...
# 12 "./1734-stm32f072/Src/1734_debug.h" 2
...
# 35 "./1734-stm32f072/Src/1734_debug.h" 3 4
_Bool 
# 35 "./1734-stm32f072/Src/1734_debug.h"
    Debug_IsJumperInstalled(void);
void Debug_SetTestLed (
# 36 "./1734-stm32f072/Src/1734_debug.h" 3 4
                      _Bool 
# 36 "./1734-stm32f072/Src/1734_debug.h"
                           led_on, int led_number);
# 10 "1734-stm32f072/Src/DSC/dsc_uart.c" 2
...
# 12 "1734-stm32f072/Src/DSC/dsc_uart.c" 2


# 13 "1734-stm32f072/Src/DSC/dsc_uart.c"
DMA_HandleTypeDef hdma_usart_tx;
UART_HandleTypeDef huart_dsc;

void dsc_uart_dma_init (void)
{
 do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x00001000UL))->AHBENR) |= ((0x1UL << (0U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x00001000UL))->AHBENR) & ((0x1UL << (0U)))); (void)tmpreg; } while(0U);


 hdma_usart_tx.Instance = ((DMA_Channel_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x00000000UL) + 0x00000044UL));
 hdma_usart_tx.Init.Direction = ((uint32_t)(0x1UL << (4U)));
 hdma_usart_tx.Init.PeriphInc = (0x00000000U);
 hdma_usart_tx.Init.MemInc = ((uint32_t)(0x1UL << (7U)));
 hdma_usart_tx.Init.PeriphDataAlignment = (0x00000000U);
 hdma_usart_tx.Init.MemDataAlignment = (0x00000000U);
 hdma_usart_tx.Init.Mode = (0x00000000U);
 hdma_usart_tx.Init.Priority = (0x00000000U);
 if (HAL_DMA_Init (&hdma_usart_tx) != HAL_OK)
 {
  Error_Handler ();
 }
 do{ (&huart_dsc)->hdmatx = &(hdma_usart_tx); (hdma_usart_tx).Parent = (&huart_dsc); } while(0);
}
...
void dsc_uart_gpio_init (void)
{
 ...
 do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x00001000UL))->AHBENR) |= ((0x1UL << (17U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x00001000UL))->AHBENR) & ((0x1UL << (17U)))); (void)tmpreg; } while(0U);
 ...
 GPIO_InitStruct.Alternate = ((uint8_t)0x01U);
 HAL_GPIO_Init (((GPIO_TypeDef *) ((0x40000000UL + 0x08000000UL) + 0x00000000UL)), &GPIO_InitStruct);
}
...
void MX_DSC_UART_Init (void)
{
 ...
 huart_dsc.Instance = ((USART_TypeDef *) (0x40000000UL + 0x00004400UL));
 huart_dsc.Init.BaudRate = 921600;
 huart_dsc.Init.WordLength = 0x00000000U;
 huart_dsc.Init.StopBits = 0x00000000U;
 huart_dsc.Init.Parity = 0x00000000U;
 huart_dsc.Init.Mode = ((0x1UL << (3U)) |(0x1UL << (2U)));
 huart_dsc.Init.HwFlowCtl = 0x00000000U;
 huart_dsc.Init.OverSampling = 0x00000000U;
 huart_dsc.Init.OneBitSampling = 0x00000000U;
 huart_dsc.AdvancedInit.AdvFeatureInit = 0x00000000U;
...
# 88 "1734-stm32f072/Src/DSC/dsc_uart.c" 3
((
# 88 "1734-stm32f072/Src/DSC/dsc_uart.c"
buffer
# 88 "1734-stm32f072/Src/DSC/dsc_uart.c" 3
) ? (void)0 : __assert_func ("1734-stm32f072/Src/DSC/dsc_uart.c", 88, __func__, 
# 88 "1734-stm32f072/Src/DSC/dsc_uart.c"
"buffer"
# 88 "1734-stm32f072/Src/DSC/dsc_uart.c" 3
))
